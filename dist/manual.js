...
export const MANUAL_VERSION='2026-09-15.4';
...
<section class="panel"><span class="tag">本次更新</span><h2>從快速收藏到自動組卷</h2><ul><li>新增「快速新增」三步驟流程，可連續拍攝多題。</li><li>可從已有答案的錯題隨機產生題目卷與答案卷。</li><li>題目與答案文字支援 Markdown 和數學公式。</li><li>圖片與 AI 指令可分開複製，手機可嘗試同時分享圖片與文字。</li></ul></section>
