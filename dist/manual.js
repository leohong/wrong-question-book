...
export const MANUAL_VERSION='2026-09-17.1';
...
<section class="panel"><h2>5. 搭配 Gemini 或 ChatGPT 辨識</h2><p>在圖片卡片展開 AI 工具後，可按「全部複製」一次將圖片與 AI 指令寫入剪貼簿，再貼到支援多格式剪貼簿的服務。若瀏覽器或目標服務只接受其中一種內容，請改用「複製圖片」與「複製指令」分開操作；也可下載圖片。</p><p>內建指令要求忽略手寫內容，把遮住或不確定的地方標示為 <code>??</code>，不猜測且不先解題；最後詢問是否需要解題並提供觀念思考與速解步驟。把辨識結果貼回文字欄位後，仍需自行核對原圖。</p></section>
